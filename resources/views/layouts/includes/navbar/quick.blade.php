...
<div class="app-navbar-item me-2 me-lg-5">
    <!--begin::Menu wrapper-->
    <div class="btn btn-icon bg-gray-200 btn-icon-gray-700 btn-active-light btn-active-color-primary w-35px h-35px w-lg-50px h-lg-50px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
        ...
        <div class="row g-0">
            <!--begin:Item-->
            <div class="col-6">
                <a href="../../demo26/dist/apps/projects/budget.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="../../demo26/dist/apps/projects/settings.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="../../demo26/dist/apps/projects/list.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="../../demo26/dist/apps/projects/users.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
        ...
        <div class="py-2 text-center border-top">
            <a href="../../demo26/dist/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
