    ...
    <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/index.html" class="menu-link active">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/ecommerce.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/projects.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/online-courses.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/marketing.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/bidding.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/pos.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/dashboards/call-center.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                ...
                                <a href="../../demo26/dist/landing.html" class="btn btn-sm btn-primary fw-bold">Explore</a>
                            </div>
                            <!--end:Landing-->
                        </div>
                        <!--end:Col-->
                        ...
                        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/logistics.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/website-analytics.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/finance-performance.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/store-analytics.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/social.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/delivery.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/crypto.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/school.html" class="menu-link py-2">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="../../demo26/dist/dashboards/podcast.html" class="menu-link py-2">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/pages/user-profile/overview.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/pages/user-profile/projects.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/pages/user-profile/campaigns.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/pages/user-profile/documents.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/pages/user-profile/followers.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/pages/user-profile/activity.html" class="menu-link">
                                        ...
                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/about.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/team.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/contact.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/licenses.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/sitemap.html" class="menu-link">
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/careers/list.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/careers/apply.html" class="menu-link">
                                        ...
                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/faq/classic.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/faq/extended.html" class="menu-link">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/blog/home.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/blog/post.html" class="menu-link">
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/pricing/column.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/pricing/table.html" class="menu-link">
                                        ...
                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/social/feeds.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/social/activity.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/social/followers.html" class="menu-link">
                                                        <span class="menu-title">Followers</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/pages/social/settings.html" class="menu-link">
                                ...
                                <div class="col-lg-5 mb-6 mb-lg-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/overview.html" class="menu-link">
                                                    <span class="menu-title">Overview</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/settings.html" class="menu-link">
                                                    <span class="menu-title">Settings</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/security.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/activity.html" class="menu-link">
                                                    <span class="menu-title">Activity</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/billing.html" class="menu-link">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/statements.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/referrals.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/api-keys.html" class="menu-link">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo26/dist/account/logs.html" class="menu-link">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/corporate/sign-in.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/corporate/sign-up.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/corporate/two-steps.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/corporate/reset-password.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/corporate/new-password.html" class="menu-link">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/overlay/sign-in.html" class="menu-link">
                                                <span class="menu-title">Sign-in</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/overlay/sign-up.html" class="menu-link">
                                                <span class="menu-title">Sign-up</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/overlay/two-steps.html" class="menu-link">
                                                <span class="menu-title">Two-steps</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/overlay/reset-password.html" class="menu-link">
                                                <span class="menu-title">Reset Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/overlay/new-password.html" class="menu-link">
                                                <span class="menu-title">New Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/creative/sign-in.html" class="menu-link">
                                                <span class="menu-title">Sign-in</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/creative/sign-up.html" class="menu-link">
                                                <span class="menu-title">Sign-up</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/creative/two-steps.html" class="menu-link">
                                                <span class="menu-title">Two-steps</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/creative/reset-password.html" class="menu-link">
                                                <span class="menu-title">Reset Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/creative/new-password.html" class="menu-link">
                                                <span class="menu-title">New Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/fancy/sign-in.html" class="menu-link">
                                                <span class="menu-title">Sign-in</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/fancy/sign-up.html" class="menu-link">
                                                <span class="menu-title">Sign-up</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/fancy/two-steps.html" class="menu-link">
                                                <span class="menu-title">Two-steps</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/fancy/reset-password.html" class="menu-link">
                                                <span class="menu-title">Reset Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/layouts/fancy/new-password.html" class="menu-link">
                                                <span class="menu-title">New Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/extended/multi-steps-sign-up.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/extended/two-factor-auth.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/general/welcome.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/general/verify-email.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/extended/coming-soon.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/general/password-confirmation.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/general/account-deactivated.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/general/error-404.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/general/error-500.html" class="menu-link">
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/welcome-message.html" class="menu-link">
                                                <span class="menu-title">Welcome Message</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/reset-password.html" class="menu-link">
                                                <span class="menu-title">Reset Password</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/subscription-confirmed.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/card-declined.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/promo-1.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/promo-2.html" class="menu-link">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo26/dist/authentication/email/promo-3.html" class="menu-link">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/general/invite-friends.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/general/view-users.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/general/select-users.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/general/upgrade-plan.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/general/share-earn.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/forms/new-target.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/forms/new-card.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/forms/new-address.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/forms/create-api-key.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/forms/bidding.html" class="menu-link">
                                        ...
                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/create-app.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/create-campaign.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/create-account.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/create-project.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/top-up-wallet.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/offer-a-deal.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/wizards/two-factor-authentication.html" class="menu-link">
                                                        <span class="menu-title">Two Factor Auth</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/search/horizontal.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/search/vertical.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/search/users.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/modals/search/select-location.html" class="menu-link">
                                        ...
                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/horizontal.html" class="menu-link">
                                                        <span class="menu-title">Horizontal</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/vertical.html" class="menu-link">
                                                        <span class="menu-title">Vertical</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/two-factor-authentication.html" class="menu-link">
                                                        <span class="menu-title">Two Factor Auth</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/create-app.html" class="menu-link">
                                                        <span class="menu-title">Create App</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/create-campaign.html" class="menu-link">
                                                        <span class="menu-title">Create Campaign</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/create-account.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/create-project.html" class="menu-link">
                                                        <span class="menu-title">Create Project</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo26/dist/utilities/wizards/offer-a-deal.html" class="menu-link">
                                                        <span class="menu-title">Offer a Deal</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                        ...
                        <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-6 mb-lg-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/widgets/lists.html" class="menu-link">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/widgets/statistics.html" class="menu-link">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/widgets/charts.html" class="menu-link">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/widgets/mixed.html" class="menu-link">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/widgets/tables.html" class="menu-link">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="../../demo26/dist/widgets/feeds.html" class="menu-link">
                                            <span class="menu-title">Feeds</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
        ...
        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
            ...
            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="https://preview.keenthemes.com/metronic8/demo26/layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-icon">
														<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
														<span class="svg-icon svg-icon-3">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
